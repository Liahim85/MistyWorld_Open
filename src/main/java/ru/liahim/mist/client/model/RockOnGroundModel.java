...
public final class RockOnGroundModel implements IModel
{
    public static final RockOnGroundModel INSTANCE = new RockOnGroundModel(ImmutableList.of());
	...
	public RockOnGroundModel retexture(ImmutableMap<String, String> textures)
    {
        ...
        return new RockOnGroundModel(builder.build(), overrides);
    }
        ...
        float x3, float y3, float z3, float u3, float v3)
    {
        ...
        side = side.rotateAround(Axis.X);
        builder.setQuadTint(tint);
        builder.setQuadOrientation(side);
        builder.setTexture(sprite);
        putVertex(builder, format, transform, side, y0, z0 - 0.46875F, x0, u0, v0);
        putVertex(builder, format, transform, side, y1, z1 - 0.46875F, x1, u1, v1);
        putVertex(builder, format, transform, side, y2, z2 - 0.46875F, x2, u2, v2);
        putVertex(builder, format, transform, side, y3, z3 - 0.46875F, x3, u3, v3);
        return builder.build();
    }
